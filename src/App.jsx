    ...
    <main className="min-h-svh b-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex">
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <p className="font-lexend mb-7 text-offwhite text-same">Escolha um sedan pelo seu preço acessível e excelente economia de combustível. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
        ...
        <div className="bg-green p-12">
          ...
          <p className="font-lexend mb-7 text-offwhite text-same">Escolha um SUV pelo seu interior espaçoso, poder e versatilidade. Perfeito para passar as férias em família ou para aventuras off-road.</p>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <p className="font-lexend mb-7 text-offwhite text-same">Passeie nos melhores carros sem os preços exorbitantes. Desfrute do conforto aprimorado de um aluguel de luxo e chegue com estilo.</p>
